            ...
            <div id="resumen" class="resumen">
                ...
                <div class="caja clearfix">
                    <div class="extras">
                        ...
                        <div class="orden">
                            <label for="etiquetas">Paquete 10 etiquetas $2 <small>(HTML, CCS3, JavaScript, Chrome)</small></label><br>
                    ...
                    <div class="total">
                        ...
                        <input id="pagar" type="submit" name="submit" class="button" value="Pagar">
                    </div>
                </div>
            </div>
